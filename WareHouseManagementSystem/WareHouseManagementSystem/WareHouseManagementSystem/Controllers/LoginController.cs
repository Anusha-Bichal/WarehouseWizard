...
namespace WareHouseManagementSystem.Controllers
{
    ...
    public class LoginController : Controller
    {
        ...
        public ActionResult Inventory(string firstNameSearch, string lastNameSearch, string roleSearch)
        {
        ...
        [HttpGet]
        public ActionResult checkOutRequest()
        {
            return View(db.Logins.ToList());
        }

        [HttpPost]
        public ActionResult checkOutRequest(string[] selectedItems)
        {
            // Process the selectedItems array and save changes
            if (selectedItems != null && selectedItems.Length > 0)
            {
                foreach (var selectedItem in selectedItems)
                {
                    // Process the selected item, e.g., update database or perform actions
                }
            ...
            // Return the filtered list view or any other appropriate view
            return View(db.Logins.ToList());
        }
